...
describe('asn1.js BER encober', function() {
  /*
  ...
  function test(name, model_definition, model_value, der_expected) {
    it(name, function() {
      ...
      der_actual = Model.encode(model_value, 'ber');
  ...
  test('should omit default value in BER', function() {
    this.seq().obj(
  ...
  it('should not require encoder param', function() {
     ...
     // Note no encoder specified, defaults to 'ber'
